...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.130"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-v1",
      "problem_contract_sha256": "5f208d1214be465e9549ea259540ef89c28aec581b4206dfc2f813570d36d7d6",
      "problem_id": "problem:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44",
      "route_id": "route:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-source-fidelity-01",
      "graph_id": "graph:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture: Let $G$ be a finite additive abelian group with $|G|$ odd. Then any subset $A$ of $G$ with $|A|=n>2$ can be written as $\\{a_1,\\ldots,a_n\\}$ in such a way that all the sums $a_1+a_2,a_2+a_3,\\ldots,a_{n-1}+a_n,a_n+a_1$ are distinct."
          },
          "statement_sha256": "17bb8b75a4faf9387dd7e8fafe94078aa416d49a1a0fd25e1c4056cb3462640f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-root",
      "route_id": "route:um-kou-21.130-kourovka-notebook-problem-21.130-459dec44-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.130-461730f9a382",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.130"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
